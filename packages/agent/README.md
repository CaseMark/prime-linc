...
<h1 align="center">prime-linc Core</h1>

<p align="center">
  Stateful agent runtime.
</p>

Release docs use the prime-linc package names. The source workspace manifests still keep inherited package names until the namespace migration is complete.

## Workspace Package

```bash
npm install prime-linc-core
```

## Quick Start

```typescript
import { Agent } from "prime-linc-core";
import { getModel } from "prime-linc-ai";
...
```typescript
declare module "prime-linc-core" {
...
```typescript
import { Agent, streamProxy } from "prime-linc-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "prime-linc-core";
