# prime-linc Documentation

prime-linc is an RLM-native coding and research harness built around a persistent IPython kernel, recursive subagents, durable sessions, and a multi-process local runtime. It began as a hard fork of pi-mono, but prime-linc is now the product, CLI, install source, and development repository.
...
- [Using prime-linc](usage.md) - interactive mode, RLM subagents, slash commands, context files, and CLI reference.
...
- [Skills](skills.md) - markdown and Python-backed skills, including how to ask prime-linc to create them.
...
- [prime-linc packages](packages.md) - bundle and share extensions, skills, prompts, and themes.
- [Custom models](models.md) - add model entries for supported provider APIs.
- [Custom providers](custom-provider.md) - implement custom APIs and OAuth flows.

## Programmatic Usage

- [SDK](sdk.md) - embed prime-linc in Node.js applications.
- [ACP mode](acp.md) - drive prime-linc from any Agent Client Protocol client.
