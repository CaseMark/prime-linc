...
Connect external services (Linear, Notion, …) to prime-linc over the
[Model Context Protocol](https://modelcontextprotocol.io).

Consistent with prime-linc's single-tool design, MCP integrations are **not**
