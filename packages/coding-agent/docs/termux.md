...
prime-linc runs on Android via [Termux](https://termux.dev/), a terminal emulator and Linux environment for Android.
...
# Clone and install prime-linc from source
git clone https://github.com/maxsonderby/prime-linc.git
cd prime-linc
npm ci
