...
Example extensions for prime-linc.

## Usage

```bash
# From the repository root, load an extension with --extension
./prime-linc.sh --extension packages/coding-agent/examples/extensions/permission-gate.ts
...
| Extension | Description |
|-----------|-------------|
| `mac-system-theme.ts` | Syncs the prime-linc theme with macOS dark/light mode |
