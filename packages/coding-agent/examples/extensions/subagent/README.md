...
prime-linc also provides native recursive delegation through `rlm.call()` and
...
- **Isolated context**: Each subagent runs in a separate prime-linc process
...
This tool executes a separate prime-linc subprocess with a delegated system prompt and tool/model configuration.
