...
export interface Settings {
	...
	bundledSkills?: BundledSkillsSettings; // Configure built-in skills shipped with prime-linc
	enableBuiltinSkills?: boolean; // default: true - load built-in skills shipped with prime-linc
...
export class SettingsManager {
	...
	getDefaultProvider(): string | undefined {
		return this.settings.defaultProvider ?? CASEDEV_PROVIDER_ID;
	}

	getDefaultModel(): string | undefined {
		return this.settings.defaultModel ?? CASEDEV_DEFAULT_MODEL_ID;
	}
