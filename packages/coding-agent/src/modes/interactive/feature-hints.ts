...
export const FEATURE_HINTS: readonly FeatureHintDefinition[] = [
	...
	{
		id: "subagents",
		getText: () => "prime-linc can delegate tasks to subagents and run them in parallel.",
	},
	{
		id: "agents-view",
	...
	},
	{
		...
		getText: () => "prime-linc keeps IPython variables and helpers between turns and compactions.",
	},
	{
		id: "context-usage",
	...
	{
		id: "auto-compaction",
		getText: () => "prime-linc automatically compacts long sessions before context fills up.",
	},
	{
		id: "auto-refine",
		getText: () => "prime-linc self-improves by refining skills, memories, prompts, and subagents.",
	},
	{
