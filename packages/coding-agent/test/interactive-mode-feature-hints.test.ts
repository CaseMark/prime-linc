...
describe("feature hint deck", () => {
	...
	it("covers prime-linc workflows with capability-focused copy", () => {
		const deck = new FeatureHintDeck(() => 0);
		...
		expect(textById.get("subagents")).toBe("prime-linc can delegate tasks to subagents and run them in parallel.");
