...
Content`,
	...
	describe("ignore files", () => {
		...
		it("should not apply parent .gitignore to project auto-discovery", async () => {
	...
	describe("settings source normalization", () => {
		...
		it("should store project local packages relative to the project config directory settings base", () => {
