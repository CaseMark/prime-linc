...
describe("PrimeOnboardingSplashComponent", () => {
	...
	it("renders a minimal first-run login action", () => {
		...
		expect(output).toContain("Welcome to prime-linc · case.dev");
		expect(output).toContain("Press Enter to login with case.dev");
	...
	it("renders a model selection action when auth is already available", () => {
		...
		expect(output).not.toContain("Press Enter to login with case.dev");
	});
	...
	it("animates the splash at an interactive cadence", () => {
		...
		expect(secondRender).toContain("Welcome to prime-linc · case.dev");
		expect(secondRender).toContain("Press Enter to login with case.dev");
	});
	...
	it("centers stacked content in narrow terminals", () => {
		...
		const brandLine = rendered.find((line) => line.includes("Welcome to prime-linc · case.dev"));
		const hintLine = rendered.find((line) => line.includes("Press Enter to login with case.dev"));
