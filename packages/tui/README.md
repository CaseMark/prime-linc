...
<h1 align="center">prime-linc TUI</h1>
...
```typescript
import { TUI, Text, Editor, ProcessTerminal, matchesKey } from "prime-linc-tui";
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "prime-linc-tui";
...
```typescript
import { Container, type Focusable, Input } from "prime-linc-tui";
...
Renders Kitty or iTerm2 terminal graphics when supported. Set `fallbackOnly: true` to show compact image metadata instead; prime-linc uses this metadata-only mode.
...
```typescript
import { CombinedAutocompleteProvider } from "prime-linc-tui";
...
```typescript
import { matchesKey, Key } from "prime-linc-tui";
...
```typescript
import { visibleWidth, truncateToWidth, wrapTextWithAnsi } from "prime-linc-tui";
...
```typescript
import { matchesKey, Key, truncateToWidth } from "prime-linc-tui";
import type { Component } from "prime-linc-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "prime-linc-tui";
import type { Component } from "prime-linc-tui";
