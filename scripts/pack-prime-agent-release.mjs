...
// TODO: Remove this R2 tarball packer once prime-linc and its internal workspace
...
const publicPackageName = process.env.PRIME_AGENT_PACKAGE_NAME || "prime-linc";
const publicCommandName = process.env.PRIME_AGENT_CMD || "prime-linc";
const releaseChannels = new Set(["stable", "beta"]);

const releasePackages = [
	{ packageDir: "ai", publicName: undefined, artifactName: "prime-linc-ai" },
	{ packageDir: "tui", publicName: undefined, artifactName: "prime-linc-tui" },
	{ packageDir: "agent", publicName: undefined, artifactName: "prime-linc-core" },
...
function printHelp() {
	console.log(`Usage: node scripts/pack-prime-linc-release.mjs --base-url url [--channel stable|beta] [--version x.y.z] [--out-dir path]

Creates private npm tarballs for R2 distribution:

  <out-dir>/artifacts/prime-linc-<version>.tgz
  <out-dir>/artifacts/prime-linc-ai-<version>.tgz
  <out-dir>/artifacts/prime-linc-core-<version>.tgz
  <out-dir>/artifacts/prime-linc-tui-<version>.tgz
